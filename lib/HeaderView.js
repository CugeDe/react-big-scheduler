...
var HeaderView = (_temp = _class = function (_Component) {
    ...
    function HeaderView(props) {
        ...
        _this.onHeaderDateClicked = function (schedulerData, datetime) {
            if (_this.props.onHeaderDateClicked) {
                _this.props.onHeaderDateClicked(schedulerData, datetime);
            }
        };
    ...
    _createClass(HeaderView, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                onHeaderDateClicked = _props.onHeaderDateClicked;
            ...
            if (cellUnit === _index.CellUnits.Hour) {
                    ...
                    if (index % minuteStepsInHour === 0) {
                        ...
                        if (typeof nonAgendaCellHeaderTemplateResolver === 'function') {
                            ...
                            element = _react2.default.createElement(
                                ...
                                {
                                    key: item.time,
                                    className: 'header3-text' + (!!item.nonWorkingTime ? ' header3-non-working-time' : ''),
                                    style: style
                                },
                ...
                headerList = headers.map(function (item, index) {
                    ...
                    return _react2.default.createElement(
                        ...
                        {
                            key: item.time,
                            className: 'header3-text' + (_this2.props.onHeaderDateClicked ? ' header3-btn' : '') + (!!item.nonWorkingTime ? ' header3-non-working-time' : ''),
                            style: style,
                            onClick: _this2.onHeaderDateClicked.bind(_this2, schedulerData, datetime)
                        },
                        _react2.default.createElement(
                            'div',
                            null,
