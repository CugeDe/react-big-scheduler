        ...
        value: function render() {
            ...
            if (cellUnit === _index.CellUnits.Hour) {
                ...
                headerList = headers.map(function (item, index) {
                    ...
                    return _react2.default.createElement(
                        'th',
                        { key: item.time, className: "header3-text" + (_this2.props.onHeaderDateClicked ? " header3-btn" : ""), style: style, onClick: _this2.onHeaderDateClicked.bind(_this2, schedulerData, datetime) },
                        _react2.default.createElement(
                            'div',
                            null,
                            pList
