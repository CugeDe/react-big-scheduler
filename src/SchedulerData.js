...
export default class SchedulerData {
    ...
    setEvents(events) {
        ...
        console.log("[setEvents] Events are validated.");
    ...
    _validateEvents(events){
        if(Object.prototype.toString.call(events) !== "[object Array]") {
            console.error('Events should be Array object');
    ...
    _createRenderData() {
        console.log("[_createRenderData] Starting up...");
        ...
        this.events.forEach((item, index) => {
            console.log(`[_createRenderData] Treating event ${index}: ${item}`);
